...
:quickstart-project-name: quickstart-microsoft-dedicated-host
...
:quickstart-contributors: Sudhir Amin, AWS for Microsoft Workloads and Dave May, AWS Integration & Automation team
