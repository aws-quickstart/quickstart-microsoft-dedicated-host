...
:partner-product-name: Microsoft dedicated hosts environment
// For the following attribute, if you have no short name, enter the same name as partner-product-name.
:partner-product-short-name: Dedicated hosts environment
...
:quickstart-contributors: Sudhir Amin, Microsoft Workloads and Dave May, AWS Quick Start team
