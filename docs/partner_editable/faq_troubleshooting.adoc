...
*Q.* What happens if one of the Availability Zones runs out of {partner-product-short-name} capacity?

*A.* If capacity is reached, new instances in the Auto Scaling group are deployed in the other Availability Zone until the first Availability Zone gains capacity.
